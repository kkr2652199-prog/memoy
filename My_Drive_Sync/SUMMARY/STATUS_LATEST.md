...
## ★ 압축대비 스냅샷 (2026-07-18 KST)

| 항목 | 값 |
|------|-----|
| SSOT (1~3군) | **kkr2652199-prog/memoy** · main · `My_Drive_Sync/SUMMARY/` |
| MAX(draw_no) | **1232** (lotto.db) |
| lead1 | **F1_V2_STRICT** · target 88~1232 |
| LM 홀딩 | **LOTTO_LLM_HOLD=True** · miss/snake **OFF** |
| 목적 (20260711) | 정직한 분석앱 · 구매=오락비 한도 · 1.5군=실험/정직성 |
| **분석 push (20260718)** | 1·2·3군 뇌×세트 독립적중·우선조합 READ-ONLY · 커밋 `0ee8df7` |
| **R34 확정 (20260718)** | 1~3군 보고/현황 memoy 전용 · 4군=kweon 분리 |
