...
| **형 설계 비전 (20260711)** | 1군 뇌별 회차누적 학습→예측→분석→진화 · `VISION_1군_뇌진화_형설계_20260711.md` |
| **목적 재정의 (20260711)** | "당첨 보장"→"정직한 분석 앱" · 구매=오락비 한도 · 1.5군=실험/정직성(적중률 목표 아님) |
...
- **STEP3 대기:** lstm 비중/eta 실제 조정 (형 결정) → **HOLD** (목적 재정의, 1.5군 우선)

## ★ 목적 재정의 + 1.5군 (기억106)
- "당첨 보장" ❌ → **정직하고 완성도 높은 나만의 분석 앱**
- 구매: **오락비 한도** · 매몰비용 회수 목적 구매 금지
- 1.5군: **학습형 통계 엔진 실험 + 시스템 정직성** (적중률 향상 목표 아님)
- **현재 STEP:** 1.5군 신설 준비 (목적 재정의 완료, 이름 결정 대기)

## 기억 체인: …104→105→**106(현재)**
